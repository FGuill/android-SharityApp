...
public class Adapter_profil_Sharity_client_vertical extends RecyclerView.Adapter<Adapter_profil_Sharity_client_vertical.ViewHolder> {
    ...
    public Adapter_profil_Sharity_client_vertical(Context c, ArrayList<CharityDons> AL_id_text, OnItemDonateClickListener listener) {
    ...
    @Override
    public Adapter_profil_Sharity_client_vertical.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                                int viewType) {
